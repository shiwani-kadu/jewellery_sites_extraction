...
def main():
    ...
    try:
        with open(f'../../input_files/van_cleef_arpels_bracelets_categories.json', 'r') as f:
    ...
    try:
        output_file = f'../../input_files/listings/van_cleef_arpels_bracelets_links_{args.region}.json'
