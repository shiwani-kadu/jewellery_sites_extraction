...
def main():
    ...
    try:
        with open(f'../../input_files/celine_men_fine_jewelry_categories.json', 'r') as f:
    ...
    try:
        output_file = f'../../input_files/listing/celine_men_fine_jewelry_links_{args.region}.json'
