...
def main():
    ...
    # Load configuration
    # token = os.environ.get("4d6a0e0cab5d4b79811b69533059e6b1eccb3b7b628")
    ...
    try:
        with open(f'../../input_files/van_cleef_arpels_cufflinks_categories.json', 'r') as f:
    ...
    try:
        output_file = f'../../input_files/listings/van_cleef_arpels_cufflinks_links_{args.region}.json'
