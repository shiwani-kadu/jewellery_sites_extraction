...
def main():
    ...
    try:
        with open(f'../../input_files/van_cleef_arpels_necklace_categories.json', 'r') as f:
    ...
    try:
        output_file = f'../../input_files/listings/van_cleef_arpels_necklace_links_{args.region}.json'
