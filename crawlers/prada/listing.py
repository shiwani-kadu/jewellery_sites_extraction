...
HEADERS = {
    ...
    'if-modified-since': 'Tue, 18 Mar 2025 21:34:43 GMT',
    'if-none-match': '"3aed76-630a4ac4ea451-gzip"',
    'priority': 'u=0, i',
...
def fetch_page(url, cookies, headers, impersonate_version, region):
    """
...
def main():
    ...
    try:
        with open(f'../../input_files/prada_categories.json', 'r') as f:
    ...
    try:
        output_file = f'../../input_files/listing/prada_links_{args.region}.json'
